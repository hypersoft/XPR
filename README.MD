...
negative-word-modification-logically-means: not [the = a] fact is the sum[=fiction [using our foregoing tables: (not a system is a process) = BACKWARDS]]. Some words start with void-fixes 
