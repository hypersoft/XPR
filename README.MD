...
For any combination of words, the formal-correct-spelling is with the hyphenation of the words, thusly forming a single-compound-word = <code>SingleCompoundWord, singleCompoundWord or SINGLE_COMPOUND_WORD</code> because hyphenation is forbidden by most software-coding-language-tools.
